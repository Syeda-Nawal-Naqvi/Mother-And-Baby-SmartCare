...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  // Pink shades used across the screen
  static const Color _darkPink = Color(0xFF9C1458); // dark pink
  static const Color _mediumPink = Color(0xFFC2185B); // medium pink
      ...
      child: Column(
        ...
        children: [
          ...
          TextFormField(
            ...
            style: GoogleFonts.poppins(fontSize: 14, color: _darkPink),
